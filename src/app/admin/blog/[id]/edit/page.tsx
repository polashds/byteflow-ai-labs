  ...
  return (
    <div className="space-y-8">
      <div>
        <Link
          href="/admin/blog"
          className="inline-flex items-center gap-2 font-body text-xs text-brand-muted hover:text-accent transition-colors tracking-[0.15em] uppercase mb-6"
        >
          ← Posts
        </Link>
        ...
        <h1 className="font-heading font-semibold text-brand-text text-4xl truncate">{post.title}</h1>
      </div>
